document.addEventListener("DOMContentLoaded", () => {
    ...
    toggleSpecialButton.classList.add("hidden"); // Ocultar el botón por defecto
    ...
    zoneButtons.forEach(button => {
        button.addEventListener("click", () => {
            ...
            zonesMenu.classList.add("hidden");
            zonesMenu.style.display = "none";
            toggleSpecialButton.classList.remove("hidden"); // Mostrar el botón al seleccionar una zona
        });
    });
